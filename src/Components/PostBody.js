...
function PostBody(props) {
    ...
    return (
            ...
            >
                ...
                { props.post.answers === undefined ?"":
                <Stack direction="column">
                    { props.post.answers[0] === undefined ? "" : <AnswerHeader post= { props.post.answers[0] }/> }
                    <Text px="6">
                        <>
                        { props.post.answers[0] === undefined ? "" : parse(props.post.answers[0].answer) }
                        </>
                    </Text>
                </Stack>
                }
